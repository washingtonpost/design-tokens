...
const LogoDocBlock = (props) => (
  <div className="ma-md mw-600">
    <div
      className={`h-lg b bc-gray-light brad-4 pa-md flex justify-center ${props.background}`}
    >
      {props.children}
    </div>
...
export const TheWashingtonPost = () => (
  <div>
    <h3 className="font-md3 light mt-lg mb-sm ml-md gray-darkest">
      The Washington Post logos
    </h3>
